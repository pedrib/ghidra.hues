...
@FileSystemInfo(
		...
		factory = GhidorahFileSystem.MyFileSystemFactory.class)
public class GhidorahFileSystem implements GFileSystem {
	 ...
	 */
	public GhidorahFileSystem(FSRLRoot fsFSRL, ByteProvider provider) {
		this.fsFSRL = fsFSRL;
	...
	public void mount(TaskMonitor monitor) {
		monitor.setMessage("Opening " + GhidorahFileSystem.class.getSimpleName() + "...");
	...
	public static class MyFileSystemFactory
			implements GFileSystemFactoryFull<GhidorahFileSystem>, GFileSystemProbeFull {

		@Override
		public GhidorahFileSystem create(FSRL containerFSRL, FSRLRoot targetFSRL,
				ByteProvider byteProvider, File containerFile, FileSystemService fsService,
				TaskMonitor monitor) throws IOException, CancelledException {

			GhidorahFileSystem fs = new GhidorahFileSystem(targetFSRL, byteProvider);
			fs.mount(monitor);
			return fs;
		}
